 ...
 */
final class Version20220606094045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE incident (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, create_at DATETIME NOT NULL, description CLOB NOT NULL)');
        ...
        $this->addSql('DROP INDEX IDX_2C7D9800C3568B40');
        $this->addSql('DROP INDEX IDX_2C7D980038C751C4');
        $this->addSql('CREATE TEMPORARY TABLE __temp__roles_customers AS SELECT roles_id, customers_id FROM roles_customers');
        $this->addSql('DROP TABLE roles_customers');
        $this->addSql('CREATE TABLE roles_customers (roles_id INTEGER NOT NULL, customers_id INTEGER NOT NULL, PRIMARY KEY(roles_id, customers_id), CONSTRAINT FK_2C7D980038C751C4 FOREIGN KEY (roles_id) REFERENCES roles (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2C7D9800C3568B40 FOREIGN KEY (customers_id) REFERENCES customers (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO roles_customers (roles_id, customers_id) SELECT roles_id, customers_id FROM __temp__roles_customers');
        $this->addSql('DROP TABLE __temp__roles_customers');
